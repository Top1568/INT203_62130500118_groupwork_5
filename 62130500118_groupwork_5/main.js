    ...
    methods: {
        ...
        search(searchInputText) {
            for (let i = 0; i < this.images.length; i++) {
                if (this.images[i].name.toLowerCase().includes(searchInputText.toLowerCase()) || this.images[i].description.toLowerCase().includes(searchInputText.toLowerCase())) {
        ...
        forwardBigImage() {
            if (this.canForward) {
                ...
                this.bigImage = this.imagesShow[0].img
            }
        },
        backwardBigImage() {
            if (this.canBackward) {
                ...
                this.bigImage = this.imagesShow[this.imagesShow.length - 1].img
            }
        }
    },
    computed: {
        ...
        orderImg() {
            return this.imagesShow.findIndex(img => this.bigImage === img.img)
        },
        canForward() {
            return this.orderImg < this.imagesShow.length - 1
        },
        canBackward() {
            return this.orderImg > 0
        }
